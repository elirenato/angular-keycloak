...
describe('Login Service', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [StateStorageService, AccountService, KeycloakService, TranslateService],
    });
  ...
  describe('Service methods', () => {
    it('Should call login', () => {
      ...
      expect(keycloakService.login).toBeCalledWith({
        locale: 'en-US',
      });
    });
    ...
    it('Should call register', () => {
      ...
      expect(keycloakService.register).toBeCalledWith({
        locale: 'pt-BR',
      });
    });
