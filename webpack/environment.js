module.exports = {
  ...
  KEYCLOAK_URL: process.env.hasOwnProperty('KEYCLOAK_URL') ? process.env.KEYCLOAK_URL : 'http://localhost:8080',
  KEYCLOAK_REALM: process.env.hasOwnProperty('KEYCLOAK_REALM') ? process.env.KEYCLOAK_REALM : 'myapp',
